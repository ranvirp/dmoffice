...
if ($x)
{
	...
	for ($i=0;$i<sizeof($y);$i++){
	  ...
	  $str.= "<li>".CHtml::link($files->originalname,Yii::app()->createUrl('/Basedata/files/file/id/'.$y[$i]));
          $str.="<div>".'<embed src="'.Yii::app()->createUrl('/Basedata/files/file/id/'.$y[$i]).'"#view=Fit" /></div>';
	
          $str.='<object data="'.Yii::app()->createUrl('/Basedata/files/file/id/'.$y[$i]).'" type="application/pdf" width="100" height="100">
