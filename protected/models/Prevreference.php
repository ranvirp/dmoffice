...
/**
 * This is the model class for table "prevreference".
 *
 * The followings are the available columns in table 'prevreference':
 * @property integer $id
...
class Prevreference extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name_hi, name_en', 'required'),
			array('name_hi, name_en', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name_hi, name_en', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Prevreference the static model class
	 */
