...
class Sanscript {
 ...
 /* Harvard-Kyotomodified 
            ...
            "hk1" => array(
                ...
                "virama" => array(""),
                "consonants" => array("k", "kh", "g", "gh", "G", "c", "ch", "j", "jh", "J", "T", "Th", "D", "Dh", "N", "t", "th", "d", "dh", "n", "p", "ph", "b", "bh", "m", "y", "r", "l", "v", "sh", "sh", "s", "h", "L", "kSha", "jJ"),
    ...
    private function setUpSchemes() {
        ...
        $schemeNames = array("iast", "itrans", "hk", "kolkata", "slp1", "velthuis", "wx",'hk1');
...
//$spldevanagris=array('न','म','स','व',);
        foreach ($dataChars as $L) {
            ...
            if (isset($marks[$L])) {
                ...
                if ($hadRomanConsonant) {
                //    if (($prevDevanagri!='न')&&($prevDevanagri!='म')&&($prevDevanagri!='स')&&($prevDevanagri!='व'))
                    $buf[] = 'a';
                    $hadRomanConsonant = FALSE;
                    $prevDevanagri='';
                }
